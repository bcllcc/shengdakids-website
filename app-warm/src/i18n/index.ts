...
export const translations: Record<Language, Translations> = {
  zh: {
    ...
    products: {
      ...
      items: {
        cloudWalk: '云端漫步系列',
        urbanExplorer: '都市探险家专业款',
        princessBow: '公主梦幻蝴蝶结',
        runningShoes: '疾风跑步运动鞋',
        classicSchool: '经典校园皮面款',
        balletFlat: '芭蕾柔软平底款',
      },
    },
    contact: {
  ...
  en: {
    ...
    products: {
      ...
      items: {
        cloudWalk: 'Cloud Walk Series',
        urbanExplorer: 'Urban Explorer Pro',
        princessBow: 'Princess Dream Bow',
        runningShoes: 'Wind Runner Sports',
        classicSchool: 'Classic School Leather',
        balletFlat: 'Soft Ballet Flat',
      },
    },
    contact: {
      subtitle: 'Contact Us',
