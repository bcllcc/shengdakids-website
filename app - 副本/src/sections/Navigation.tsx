        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden lg:flex items-center gap-2">
            {navLinks.map((link) => (
              <a
                ...
                className="px-4 py-2 text-sm font-bold uppercase tracking-widest transition-all duration-200 border-2 border-transparent hover:border-black hover:bg-brand-primary hover:shadow-[2px_2px_0px_rgba(0,0,0,1)] rounded-xl text-black"
              >
                {link.name}
              </a>
            ))}
          ...
          <div className="hidden lg:flex items-center gap-4">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl border-2 border-black hover:bg-brand-primary hover:shadow-[2px_2px_0px_rgba(0,0,0,1)] hover:-translate-y-0.5 hover:-translate-x-0.5 transition-all text-sm font-bold text-black uppercase"
            >
            ...
            <a
              ...
              className="hidden xl:flex items-center gap-2 text-black hover:text-brand-primary transition-colors font-bold"
            >
              <Phone className="w-4 h-4" strokeWidth={2.5} />
              <span className="text-sm uppercase tracking-wide">400-888-8888</span>
            </a>
            <a
              href="#contact"
              onClick={(e) => {
